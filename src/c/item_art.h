...
#define UI_ICON_TAVERN 8
#define UI_ICON_SETTINGS 9
#define UI_ICON_PORTAL 10
#define UI_ICON_WALK_BACK 11
#define UI_ICON_POTION 12
#define UI_ICON_PORTAL_SCROLL 13
#define UI_ICON_IDENTIFY_SCROLL 14
